  ...
  return (
    <main className="container mx-auto p-4 pt-16 flex justify-center">
      <div className="w-full max-w-xs">
        <h1 className="text-3xl font-bold text-center mb-8 text-white drop-shadow-lg">회원가입</h1>
        <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <div className="mb-4">
            ...
            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="아이디를 입력하세요" />
          </div>
          <div className="mb-6">
