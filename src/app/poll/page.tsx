...
export default function PollListPage() {
  ...
  return (
    <main className="container mx-auto p-4 pt-16">
      <h1 className="text-3xl font-bold text-center mb-8 text-white">투표 목록</h1>
          ...
          <div key={poll.id} className="bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-3">
              {poll.options.map((option) => (
                <div key={option.id} className="flex items-center justify-between bg-gray-700 p-3 rounded-md">
