...
- [ ] `next build --analyze`로 `_next/static/chunks/117-60ec0d4eaa7cc599.js`, `52774a7f-5449a2939f6e8b6e.js`, `559-9b01b5c12a237053.js`가 어떤 컴포넌트에서 생성되는지 파악하고 145KiB의 사용하지 않는 JS를 제거합니다.
- [ ] `browserslist`와 Next.js `target`을 최신 크롬/사파리 중심으로 좁혀 불필요한 Legacy 폴리필을 빌드에서 제외합니다. 꼭 필요한 경우에만 조건부로 폴리필을 로드합니다.
