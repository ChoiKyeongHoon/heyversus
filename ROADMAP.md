...
14. **Step 13** – ⏳ 예정: 비공개 투표 초대 기능.
15. **Step 14** – ⏳ 예정: 랜덤 투표 기능.
16. **Step 15** – ⏳ 예정: 투표 이미지 업로드 기능.
17. **Step 16** – ⏳ 예정: 관리자 운영 대시보드.
